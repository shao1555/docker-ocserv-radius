...
docker-ocserv is an OpenConnect VPN Server boxed in a Docker image originally built by [Tommy Lau](mailto:tommy@gen-new.com), modified by shao (SAWADA, Sho).

## Update on Dec 9, 2019
Update to version 0.12.5, includes AWS CLI toolchain, enable RADIUS (radcli) module, and use Alpine 3.10 as base image
